...
import {saveSearch, deleteSearh, clearSearch, savePlay, saveFavourite, deleteFavourite} from 'common/js/cache'
...
export const deleteSearchHistory = function ({commit}, query) {
  commit(types.SET_SEARCH_HISTORY, deleteSearh(query))
}
